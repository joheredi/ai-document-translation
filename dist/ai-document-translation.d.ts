...
declare type AllSubPaths<BasePath extends keyof Routes_2> = HasSubPaths<BasePath, keyof Routes_2>;
...
declare type HasSubPaths<BasePath extends keyof Routes_2, LeafRoutes extends keyof Routes_2> = LeafRoutes extends `${BasePath}/${infer SubRoute}` ? `/${SubRoute}` : never;
...
declare type PathClient = <T extends keyof Routes_2>(path: T, ...args: RouteParams_2<T>) => PathReturn<T>;
