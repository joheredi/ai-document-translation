import { SubmitBatchRequestParameters, GetOperationsParameters, GetDocumentStatusParameters, GetOperationStatusParameters, CancelOperationParameters, GetOperationDocumentsStatusParameters, GetDocumentFormatsParameters, GetGlossaryFormatsParameters, GetDocumentStorageSourceParameters } from "./parameters";
...
import { ClientOptions, PathUncheckedClient } from "@azure-rest/core-client";
...
export default function DocumentTranslation(endpoint: string, credentials: TokenCredential | KeyCredential, options?: ClientOptions): DocumentTranslationClient;
